...
namespace FontAwesome.WPF
{
    ...
    public static class Awesome
    {
        ...
        public static void SetContent(DependencyObject target, FontAwesomeIcon value) => target.SetValue(ContentProperty, value);
